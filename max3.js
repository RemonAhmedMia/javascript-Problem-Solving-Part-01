...
//Math হচ্ছে JavaScript এর একটি built-in object
// এর ভেতরে অনেক গুলো mathematical কাজের জন্য বানানো ফাংশন ও প্রপার্টি আছে।
// তুমি এটা ব্যবহার করতে পারো কোনো লাইব্রেরি না দিয়েই — কারণ এটা JavaScript-এর ভিতরেই আছে।

// **Math object-এর কিছু useful method:

// Math.max(a, b, c...) = সবচেয়ে বড় সংখ্যাটা return করে 
// Math.min(a, b, c...) = সবচেয়ে ছোট সংখ্যাটা return করে
// Math.round(x) = কাছাকাছি পূর্ণসংখ্যায় রাউন্ড করে
// Math.floor(x) = নিচের পূর্ণসংখ্যায় রাউন্ড করে
// Math.ceil(x) = উপরের পূর্ণসংখ্যায় রাউন্ড করে
// Math.random() = 0 থেকে 1 এর মধ্যে random সংখ্যা দেয়
// Math.pow(base, power) = power হিসেব করে (যেমন 2^3 = 8)
// Math.sqrt(x) = কোন সংখ্যার বর্গমূল বের করে
